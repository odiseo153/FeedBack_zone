...
import { ArrowLeft, Upload, X, Github, ExternalLink, Plus } from 'lucide-react';
        ...
        <AppLayout>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Share Your Project</h1>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-4">
                            ...
                            <Button type="submit" disabled={processing}>
                                {processing ? 'Submitting...' : isDraft ? 'Save Draft' : 'Share Project'}
                            </Button>
                        </div>
                    </div>
                </form>
